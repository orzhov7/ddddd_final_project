...
l_stops <- read.csv("list_of_l_stops.csv") %>%
  select(Station_Name = STATION_NAME, Red_Line = RED, Blue_Line = BLUE, Green_Line = G, Brown_Line = BRN, Purple_Line = P, Purple_Express_Line = Pexp, Yellow_Line = Y, Pink_Line = Pnk, Orange_Line = O, Location) %>%
...
unique( l_stops_conversion )
# Review station stops (change Ran Ryan to Dan Ryan)
```
