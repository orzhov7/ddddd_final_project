...
```{r push_l_stops_final_to_sql}
# Push l_stops_final data to MySQL DB
...
stops_and_zips_2 <- stops_and_zips %>% 
  mutate(distance = acos(sin(Stop_Latitude*pi/180)*sin(Zip_Latitude*pi/180) + cos(Stop_Latitude*pi/180)*cos(Zip_Latitude*pi/180) * cos(Zip_Longitude*pi/180 - Stop_Longitude*pi/180)) * 6371)
stops_and_zips_2
```
